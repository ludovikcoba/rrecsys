...
First thing first, to use a RS you should start from a data set, more specificly a rating matrix. In this case rrecsys is built to start process any available matrix as long as the user has a clear idea of the composition of the it’s rating matrix. In a rating matrix all 0 or NULL valuaes will be considered as missing values. The users will be on rows and the items will be on columns. 
