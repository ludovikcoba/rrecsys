...
binML
```
In this case all the rating in mlLatest100k with a value larger or equal to _goodRating_ are converted to 1 and the rest to NA. This conversion has no scientific relevance, just used for demonstration purposes on OCCF.
