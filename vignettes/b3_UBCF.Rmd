...
%\VignetteIndexEntry{2.3 User-based k-nearest neighbors}
-->
...
The similarity is measured based on three algorithms: cosine(simFunct ='cos'), adjusted cosine(simFunct = 'AdjCos') and Pearson Correlation(simFunct = 'Pearson').
